...
with col1:
    ...
    fig = px.histogram(
        ...
        color_discrete_sequence=['#3a6b35', '#5d8c4e', '#7fa86a', '#9bc17a', '#bbda9b'],
        opacity=0.75
    )
    fig.update_layout(
        plot_bgcolor='white',
...
with col2:
    ...
    fig = px.bar(
        ...
        y=country_avg.index,
        orientation='h',
        title="Average Score (Higher = More Vulnerable)",
        labels={'x': 'Vulnerability Score', 'y': ''},
        color=country_avg.values,
        color_continuous_scale=['#bbda9b', '#9bc17a', '#7fa86a', '#5d8c4e', '#3a6b35'],
...
with col2:
    ...
    **{worst_country}** exhibits the highest average vulnerability score at **{worst_score:.1f}/100**, indicating a systemic deficit in healthcare infrastructure relative to population needs. This finding suggests that resource allocation strategies must account for significant inter-country disparities.
    """)
    ...
    **Identifying High-Priority Intervention Zones**
    ...
    The most vulnerable district, located in **{worst_district['country']}**, achieves a vulnerability score of **{worst_district['vulnerability_score']:.1f}/100**. This district represents the extreme of healthcare exclusion and should be prioritized for targeted infrastructure investment.
    """)
    ...
    **Population Level Impact Assessment**
    ...
    Across all districts analyzed, an average of **{total_desert_area:.1f}%** of land area lies beyond 10km of any health facility. This translates to an estimated population of **approximately 15 million people** across East Africa who lack adequate geographic access to healthcare services.
    """)
...
with col1:
    ...
    **1. Geographic Disparities in Healthcare Access**
    
    Tanzania has the highest concentration of critical districts (13), followed by Ethiopia (5). Zanzibar islands present the most extreme case with 100% of land area beyond 10km of any health facility.
    
    **2. Socioeconomic Determinants**
    
    High-risk districts have poverty rates **18-25 percentage points higher** than low-risk districts, indicating economic marginalization and healthcare exclusion are mutually reinforcing.
    
    **3. Health Outcome Disparities**
    
    Critical vulnerability districts exhibit child mortality rates significantly higher than low-risk counterparts, underscoring the profound implications of healthcare exclusion.
    
    **4. Population Impact**
    
    Approximately **15 million people** across East Africa lack adequate geographic access to healthcare services.
    """)
...
with col2:
    ...
    **Priority 1: Immediate Infrastructure Investment**
    
    Build facilities in Zanzibar's 5 districts (100% desert) and establish mobile clinics in Ethiopia's critical districts.
    
    **Priority 2: Integrated Policy Framework**
    
    Healthcare investment must be integrated with poverty reduction strategies in high-vulnerability areas.
    
    **Priority 3: Data-Driven Resource Allocation**
    
    Adopt a vulnerability-weighted funding formula to ensure districts with greatest need receive proportional investment.
    
    **Priority 4: Telemedicine and Mobile Health**
    
    For geographically isolated districts, prioritize telemedicine infrastructure and mobile health clinics.
    
    **Priority 5: Cross-Border Learning**
    
    Rwanda's low vulnerability score (20.9/100) offers lessons for higher-vulnerability nations.
    """)
